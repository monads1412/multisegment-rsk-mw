...
SampleDescriptors ==
{
    << <<Segment(-5, -5), 2>> >>,
    << <<Segment(-5, -4), 1>> >>,
    << <<Segment(-5, -4), 1>>, <<Segment(1, 2), 2>>, <<Segment(4, 5), 1>> >>,
    << <<Segment(-5, -4), 2>>, <<Segment(-5, 2), 2>> >>,
    << <<Segment(-5, -4), 2>>, <<Segment(-1, -1), 1>> >>,
    << <<Segment(-5, -2), 2>> >>,
    << <<Segment(-5, 0), 1>>, <<Segment(-4, 1), 2>>, <<Segment(-3, -3), 1>> >>,
    << <<Segment(-5, 0), 1>>, <<Segment(1, 3), 1>> >>,
    << <<Segment(-5, 1), 1>> >>,
    << <<Segment(-5, 3), 1>>, <<Segment(-4, 4), 2>>, <<Segment(0, 2), 1>> >>,
    << <<Segment(-5, 3), 1>>, <<Segment(1, 1), 2>>, <<Segment(2, 4), 1>> >>,
    << <<Segment(-5, 4), 1>>, <<Segment(-3, 0), 1>>, <<Segment(-1, 4), 1>> >>,
    << <<Segment(-5, 5), 1>> >>,
    << <<Segment(-5, 5), 1>>, <<Segment(0, 4), 2>>, <<Segment(2, 2), 1>> >>,
    << <<Segment(-4, -4), 1>> >>,
    << <<Segment(-4, -4), 1>>, <<Segment(1, 2), 1>>, <<Segment(4, 5), 1>> >>,
    << <<Segment(-4, -3), 1>> >>,
    << <<Segment(-4, -3), 1>>, <<Segment(-3, -2), 2>>, <<Segment(-2, 4), 1>> >>,
    << <<Segment(-4, -3), 2>> >>,
    << <<Segment(-4, 2), 2>>, <<Segment(-3, 1), 1>>, <<Segment(-3, 5), 1>> >>,
    << <<Segment(-4, 3), 2>> >>,
    << <<Segment(-4, 5), 1>>, <<Segment(1, 5), 2>> >>,
    << <<Segment(-4, 5), 2>> >>,
    << <<Segment(-3, -3), 1>>, <<Segment(-1, 3), 1>> >>,
    << <<Segment(-3, -2), 1>>, <<Segment(0, 5), 1>> >>,
    << <<Segment(-3, -2), 2>>, <<Segment(-2, 1), 1>> >>,
    << <<Segment(-3, -1), 2>>, <<Segment(-3, 3), 2>> >>,
    << <<Segment(-3, -1), 2>>, <<Segment(-2, 2), 1>> >>,
    << <<Segment(-3, 0), 2>> >>,
    << <<Segment(-3, 1), 1>>, <<Segment(0, 1), 1>>, <<Segment(1, 3), 1>> >>,
    << <<Segment(-3, 2), 1>>, <<Segment(-2, 1), 2>>, <<Segment(0, 0), 1>> >>,
    << <<Segment(-3, 5), 1>>, <<Segment(-1, 3), 1>>, <<Segment(0, 3), 1>> >>,
    << <<Segment(-2, -1), 1>>, <<Segment(1, 2), 2>>, <<Segment(5, 5), 1>> >>,
    << <<Segment(-1, 1), 1>>, <<Segment(0, 4), 2>> >>,
    << <<Segment(-1, 1), 1>>, <<Segment(0, 5), 1>> >>,
    << <<Segment(-1, 3), 2>> >>,
    << <<Segment(-1, 5), 2>> >>,
    << <<Segment(0, 4), 2>> >>,
    << <<Segment(3, 5), 1>> >>,
