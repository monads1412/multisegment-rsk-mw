...
SampleCount == 40
EndpointBound == 5
MaxDistinctSegments == 3
MaxMultiplicity == 2
MaxTotalCardinality == 4
RandomSeed == 12345
...
RandomMultisegments ==
{
    ...
    <<Segment(-5, -4)>>,
    <<Segment(1, 2), Segment(4, 5), Segment(-5, -4), Segment(1, 2)>>,
    <<Segment(-5, -4), Segment(-5, 2), Segment(-5, -4), Segment(-5, 2)>>,
    <<Segment(-5, -4), Segment(-1, -1), Segment(-5, -4)>>,
    <<Segment(-5, -2), Segment(-5, -2)>>,
    <<Segment(-4, 1), Segment(-4, 1), Segment(-5, 0), Segment(-3, -3)>>,
    <<Segment(1, 3), Segment(-5, 0)>>,
    <<Segment(-5, 1)>>,
    <<Segment(-5, 3), Segment(0, 2), Segment(-4, 4), Segment(-4, 4)>>,
    <<Segment(-5, 3), Segment(2, 4), Segment(1, 1), Segment(1, 1)>>,
    <<Segment(-5, 4), Segment(-1, 4), Segment(-3, 0)>>,
    <<Segment(-5, 5)>>,
    <<Segment(2, 2), Segment(0, 4), Segment(-5, 5), Segment(0, 4)>>,
    <<Segment(-4, -4)>>,
    <<Segment(-4, -4), Segment(1, 2), Segment(4, 5)>>,
    <<Segment(-4, -3)>>,
    <<Segment(-3, -2), Segment(-4, -3), Segment(-2, 4), Segment(-3, -2)>>,
    <<Segment(-4, -3), Segment(-4, -3)>>,
    <<Segment(-3, 5), Segment(-3, 1), Segment(-4, 2), Segment(-4, 2)>>,
    <<Segment(-4, 3), Segment(-4, 3)>>,
    <<Segment(-4, 5), Segment(1, 5), Segment(1, 5)>>,
    <<Segment(-4, 5), Segment(-4, 5)>>,
    <<Segment(-1, 3), Segment(-3, -3)>>,
    <<Segment(0, 5), Segment(-3, -2)>>,
    <<Segment(-3, -2), Segment(-2, 1), Segment(-3, -2)>>,
    <<Segment(-3, -1), Segment(-3, -1), Segment(-3, 3), Segment(-3, 3)>>,
    <<Segment(-2, 2), Segment(-3, -1), Segment(-3, -1)>>,
    <<Segment(-3, 0), Segment(-3, 0)>>,
    <<Segment(0, 1), Segment(1, 3), Segment(-3, 1)>>,
    <<Segment(-3, 2), Segment(-2, 1), Segment(-2, 1), Segment(0, 0)>>,
    <<Segment(0, 3), Segment(-3, 5), Segment(-1, 3)>>,
    <<Segment(1, 2), Segment(-2, -1), Segment(5, 5), Segment(1, 2)>>,
    <<Segment(0, 4), Segment(-1, 1), Segment(0, 4)>>,
    <<Segment(0, 5), Segment(-1, 1)>>,
    <<Segment(-1, 3), Segment(-1, 3)>>,
    <<Segment(-1, 5), Segment(-1, 5)>>,
    <<Segment(0, 4), Segment(0, 4)>>,
    <<Segment(3, 5)>>,
    <<Segment(5, 5)>>
}
